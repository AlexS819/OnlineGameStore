-- Етап 2: Наповнення бази даних тестовими даними
-- Усі ID генеровані як випадкові професійні V4 UUID для повної реалістичності

-- 1. Вставка видавців (Publishers)
...
-- 5. Зв'язок Багато до Багатьох (Game Genres)
...
-- 7. Вставка ключів на склад (Activation Keys)
INSERT INTO activation_keys (id, key_value, status, game_id, order_id) VALUES
-- Проданий ключ (The Witcher 3) для замовлення d1d1d1d1...
